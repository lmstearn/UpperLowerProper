...
REM =======================================================================================================
SET "MYBASEGAME=Games\Steam\steamapps\common\Fallout New Vegas"
REM Only 32 bit versions of Steam:
REM Program Files (x86)\Games\Steam\steamapps\common\Fallout New Vegas


SET "MYGAMESGAME=%UserProfile%\Documents\My Games\FalloutNV"
REM Older systems use "My Documents"
SET "MYAPPDATAGAME=%LocalAppData%\FalloutNV"
REM =======================================================================================================
