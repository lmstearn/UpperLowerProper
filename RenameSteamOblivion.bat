...
set "CREATKITPROC=TESConstructionSet.exe"
set CREATKIT=
...
REM =======================================================================================================
SET "MYBASEGAME=Games\Steam\steamapps\common\Oblivion"
REM Only 32 bit versions of Steam:
REM Program Files (x86)\Games\Steam\steamapps\common\Oblivion


SET "MYGAMESGAME=%UserProfile%\Documents\My Games\Oblivion"
REM Older systems use "My Documents"
SET "MYAPPDATAGAME=%LocalAppData%\Oblivion"
REM =======================================================================================================
